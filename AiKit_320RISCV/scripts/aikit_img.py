...
class Object_detect():
    ...
    def __init__(self, camera_x=255, camera_y=5):
        # inherit the parent class
        super(Object_detect, self).__init__()

        # declare mycobot 320 riscv
        self.mc = None
        # 移动角度
        self.move_angles = [
    ...
    def move(self, x, y, color):
        ...
        self.mc.send_coords([x, y, 94, -173.84, -0.14, -74.37], 100, 1)  #
        self.check_position([x, y, 94, -173.84, -0.14, -74.37], 1, max_same_data_count=30)
    ...
    def run(self):
        ...
        self.gpio_status(False)
        self.mc.send_angles([0.61, 45.87, -92.37, -41.3, 89.56, 9.58], 35)
...
def run():
    ...
    # sift = cv2.xfeatures2d.SIFT_create()  # opencv <=4.6
    sift = cv2.SIFT_create()  # opencv > 4.6
