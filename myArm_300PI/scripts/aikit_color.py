...
class Object_detect():
    ...
    def move(self, x, y, color):
        ...
        print(color)
        self.ma.send_angles(self.move_angles[1], 35)
        time.sleep(3)
        ...
        self.ma.send_coords([x, y, 103, 179.87, -3.78, -62.75], 40, 1)
        time.sleep(3)
    ...
    def run(self):
        ...
        self.gpio_status(False)
        self.ma.send_angles([-60, 0, 0, -90, 0, -90, 0], 40)
        time.sleep(2.5)
...
if __name__ == "__main__":
    ...
    while cv2.waitKey(1) < 0:
        ...
        # calculate params of the coords between cube and myArm 300 计算立方体和 myArm 之间坐标的参数
        if nparams < 10:
            if detect.get_calculate_params(frame) is None:
                cv2.imshow("figure", frame)
                continue
        ...
        if detect_result is None:
            ...
            x, y = detect_result
            # calculate real coord between cube and myArm 300 计算立方体和 myArm 之间的真实坐标
