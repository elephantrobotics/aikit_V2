...
class Object_detect():
    ...
    def move(self, x, y, color):
        ...
        self.ma.send_coords([x, y, 68, -179.72, 6.5, -179.43], 40, 1)  # [165.0, 0.9, 109.6, 179.69, 0.08, 179.78]
        time.sleep(3)
    ...
    # set parameters to calculate the coords between cube and myarm
    def set_params(self, c_x, c_y, ratio):
        self.c_x = c_x
        self.c_y = c_y
        self.ratio = 220.0 / ratio

    # calculate the coords between cube and myarm
...
def run():
    ...
    while True:
        ...
        # calculate params of the coords between cube and myarm
        if nparams < 10:
            if detect.get_calculate_params(frame) is None:
                # cv2.imshow("figure", frame)
                continue
            ...
            nparams += 1
            # calculate and set params of calculating real coord between cube and myarm
        ...
        for i, v in enumerate(res_queue):
            ...
            if detect_result:
                x, y = detect_result
                # calculate real coord between cube and myarm
