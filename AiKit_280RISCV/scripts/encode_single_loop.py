...
class Detect_marker():
    ...
    def move(self, x, y, color):
        ...
        # 抓取后放置区域
        self.mc.send_angles(move_target_angles[color-1], 50)  # move_target_angles[0] 为A分拣区，move_target_angles[1] 为B分拣区, move_target_angles[2] 为C分拣区，move_target_angles[3] 为D分拣区
        self.check_position(move_target_angles[color-1], 1)
