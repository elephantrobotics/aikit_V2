"""
280PI_wireless_keyboard_mouse_handle_control_raspi_linux.py
This script is suitable for using a wireless keyboard and mouse controller combination to control the mycobot 280 machine with a controller.
