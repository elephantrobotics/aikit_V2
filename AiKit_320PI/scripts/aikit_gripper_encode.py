...
class Detect_marker():
    ...
    def move(self, x, y, color, yaw_degrees):
        ...
        target1 = [round([0][0] + x, 2), round([0][1] + y, 2), 250, tmp_coords[3], tmp_coords[4], tmp_coords[5]]
        ...
        #                     1)
        target2 = [round([0][0] + x, 2), round([0][1] + y, 2), 203, tmp_coords[3], tmp_coords[4], tmp_coords[5]]
