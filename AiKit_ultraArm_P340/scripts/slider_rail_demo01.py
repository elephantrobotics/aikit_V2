...
class Object_detect():
    ...
    def __init__(self, camera_x=202, camera_y=370):
    ...
    def move(self, x,y,color):
        ...
        move_angles = [
            ...
            [13.75, 0.0, 0.0, 0.0], # 识别抓取之后的缓冲点
            [55.58, 0.0, 0.0, 0.0],  # point to grab
        ]
        ...
        self.ua.set_coords([x, y, 53.97], 60)
        self.ua.sleep(2.5)
        # open pump
        self.pub_pump(True)
        time.sleep(1)
    ...
    def pump_to_send(self):
        ...
        for i in range(0, 5):
            ...
            if (245 <= current_detect_dist and 361 >= current_detect_dist):
                # 最上方木块
                if (self.detect_tof_distance(current_detect_dist, 245, 285)):
                    ...
                    is_detect = True
                    count = 2
                elif (self.detect_tof_distance(current_detect_dist, 336, 350)):
                    is_detect = True
                    count = 3
                
                elif (self.detect_tof_distance(current_detect_dist, 351, 361)):
                    is_detect = True
                    count = 4
            else:
