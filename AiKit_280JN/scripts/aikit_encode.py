...
class Detect_marker():
    ...
    def move(self, x, y, color):
        ...
        # time.sleep(2)
        self.mc.send_coords([coords[0][0] + x, coords[0][1] + y, 160, 178.99, -3.78, -62.9], 40, 1)

        self.mc.send_coords([coords[0][0] + x, coords[0][1] + y, 30, 178.99, -3.78, -62.9], 40, 1)
        self.check_position([coords[0][0] + x, coords[0][1] + y, 30, 178.99, -3.78, -62.9], 1)

        # open pump
        if "dev" in self.robot_raspi or "dev" in self.robot_jes:
            self.pub_pump(True)
        time.sleep(1.5)
